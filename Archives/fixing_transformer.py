...
class MLP_mixer_Head(nn.Module):
    def __init__(self):
        ...
        #self.fc3 = nn.Linear(1344,1152)
        #self.fc4 = nn.Linear(1152, 968)
...
summary(model=model,
         input_size=(128, 1, 224, 224), # (batch_size, color_channels, height, width)
...
train_dataloader_pretrained, test_dataloader_pretrained, class_names = data_setup.create_dataloaders(train_dir=train_dir,
        test_dir=test_dir, transform=transforms, batch_size=128)
